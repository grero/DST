function myDST6(homeDir,results)
...
% squareArea = results.parameters.squareArea;
...
filename = [homeDir '/results_DST/results_Set3_' num2str(a(1)) '_' num2str(a(2)) '_' num2str(a(3)) '.mat'];
trialcountfilename = [homeDir '/results_DST/trialcount_Set3' num2str(a(1)) '_' num2str(a(2)) '_' num2str(a(3)) '.mat'];

k = 1;
while exist(filename) %#ok<*EXIST>
    k = k + 1;
    filename = [homeDir '/results_DST/results_Set3_' num2str(a(1)) '_' num2str(a(2)) '_' num2str(a(3)) '(' num2str(k) ').mat'];
end
...
try
    ...
    fromY = (windowRect(4) - floor(windowRect(4)/squareArea) * squareArea) / 2;
    ...
    while continueTask == 1 && floor(whichTrial/numLocations) ~= blocknum
        ...
        locationsTrial = cuelocationsIndexShuffled(blTrial);
        ...
        while startTask == 0
            ...
            for linesX = 1:numDivisionsGrid(2)+1
                Screen('DrawLine', window ,[0 0 0], fromX, fromY+squareArea*(linesX-1), toX, fromY+squareArea*(linesX-1) ,2);
            end
            for linesY = 1:numDivisionsGrid(1)+1
                Screen('DrawLine', window ,[0 0 0], fromX+squareArea*(linesY-1), fromY, fromX+squareArea*(linesY-1), toY ,2);
            end
        ...
        %% PRESENT CUE and RESPONSE PERIOD
            ...
            if posX > cueRect(1) && posX < cueRect(3) && posY > cueRect(2) && posY < cueRect(4)
                ...
                if iteration == 1
                    ...
                    if targetColor == [0 255 0]
                        starget = GetSecs;
                        SendEvent([1 0 xbinmod ybinmod],dio);
                        etarget = GetSecs;
                        if mouse == 0
                    ...
                    elseif targetColor == [255 0 0]
                        starget = GetSecs;
                        SendEvent([0 1 xbinmod ybinmod],dio);
                        etarget = GetSecs;
                        if mouse == 0
            ...
            if reward == 1
                ...
                while GetSecs - timeIniFeedback < feedbackTime
                    ...
                    if iteration == 1
                        ...
                        Snd('Play',rewardbeep);
                        sreward = GetSecs;
                        SendEvent([0 0 0 0 0 1 1 0],dio);
                        ereward = GetSecs;
                        if mouse == 0
                            Eyelink('Message', num2str([0 0 0 0 0 1 1 0]));
                        end
                        if rand<=rewardprob
                            DST_reward(numreward,rewardduration,AO)
                        end
                    end
