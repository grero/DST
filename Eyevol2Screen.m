function X_adj  = Eyevol2Screen(data,eyecoilcoords,GridCols,GridRows,CenterX,CenterY,Xsize,Ysize)
...
X_adj(1,:)=griddata(eyex,eyey, screenx, data(hchan,:), data(vchan,:),'v4');
X_adj(2,:)=griddata(eyex,eyey, screeny, data(hchan,:), data(vchan,:),'v4');
