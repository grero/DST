...
filename = [homeDir '/results_DST/results_Set4_' num2str(a(1)) '_' num2str(a(2)) '_' num2str(a(3)) '.mat'];
trialcountfilename = [homeDir '/results_DST/trialcount_Set4' num2str(a(1)) '_' num2str(a(2)) '_' num2str(a(3)) '.mat'];

k = 1;
while exist(filename) %#ok<*EXIST>
    k = k + 1;
    filename = [homeDir '/results_DST/results_Set4_' num2str(a(1)) '_' num2str(a(2)) '_' num2str(a(3)) '(' num2str(k) ').mat'];
end
...
%         end
        ...
        results.srespond(whichTrial) = srespond;
